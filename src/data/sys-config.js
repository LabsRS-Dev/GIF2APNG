...
const SysConfig = {
  ...
  homepage:
    internal.getHomePage() ||
    'https://gmagon.com/products/store/gmagon_gif/index.html',
  docPage:
    internal.getDocPage() ||
    'https://gmagon.com/products/store/gamgon_gif/docs.html',
  newsDataUrl:
    internal.getNewsDataUrl() ||
    'https://gmagon.com/products/store/gmagon_gif/data/news.json',
  companyName: internal.getVendorName() || 'GMagon',
  companyWebsiteHomepage:
    internal.getVendorWebSiteURL() || 'https://gmagon.com',
