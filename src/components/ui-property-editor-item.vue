        ...
        if (!that.$el.contains(e.target)) {
          ...
          if (!that.$refs['popoverButton'].$el.contains(e.target)) {
            if (that.ifComponentAsUiTextBox && that.hasPopover && !that.popoverDialog.isOpen) {
              that.popoverDialog.title = that.$t('pages.convert.dialog-popover-confirm-edit.title')
              that.popoverDialog.confirmButtonText = that.$t('pages.convert.dialog-popover-confirm-edit.btnConfirm')
              that.popoverDialog.denyButtonText = that.$t('pages.convert.dialog-popover-confirm-edit.btnDeny')
