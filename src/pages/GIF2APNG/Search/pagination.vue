  ...
  <nav>
    <ul class="pagination">
      <li :class="{'disabled': current == 1}">
        <a href="javascript:;" rel="external nofollow" @click="setCurrent(1)"> <i class="fa fa-angle-double-left fa-lg"></i> </a>
      </li>
      <li :class="{'disabled': current == 1}">
      ...
      <li :class="{'disabled': current == page}">
        <a href="javascript:;" rel="external nofollow" @click="setCurrent(current + 1)"> <i class="fa fa-angle-right fa-lg"></i> </a>
      </li>
      <li :class="{'disabled': current == page}">
        <a href="javascript:;" rel="external nofollow" @click="setCurrent(page)"> <i class="fa fa-angle-double-right fa-lg"></i> </a>
      </li>
    </ul>
  </nav>
</template>
