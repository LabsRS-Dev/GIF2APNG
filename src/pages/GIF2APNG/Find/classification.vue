<template>
    <div class="children__router__content__classification">
        ...
        <div class="children__router__content__classification__content">
            <dl>
                <image-cover :img-src="item.image" v-for="item in labelList" v-show="$route.path.match(/classification/)" :introduce="item.introduce" :viewCount="item.viewCount"></image-cover>
            </dl>
        </div>
    </div>
</template>
